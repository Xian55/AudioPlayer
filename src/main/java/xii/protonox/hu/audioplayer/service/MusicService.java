package xii.protonox.hu.audioplayer.service;
...
/**
 * Created by poler on 2015. 11. 16..
 */
public class MusicService extends Service implements MediaPlayer.OnPreparedListener, MediaPlayer.OnErrorListener, MediaPlayer.OnCompletionListener{
    ...
    //Unique id of the currently playing song
    ...
    //Notification CODES
    private final String ACTION_STOP = "xii.protonox.hu.audioplayer.STOP";
    private final String ACTION_NEXT = "xii.protonox.hu.audioplayer.NEXT";
    private final String ACTION_PREVIOUS = "xii.protonox.hu.audioplayer.PREVIOUS";
    private final String ACTION_PAUSE = "xii.protonox.hu.audioplayer.PAUSE";


    //FSM to music play states
    ...
    //enhance the music player with backgound play ability
    ...
    //Show/Init the notification bar in the ActionBarDrawer
    //Enhance with the ability to listen the Action Requests
    //Such as play/pause/stop/next/prev
